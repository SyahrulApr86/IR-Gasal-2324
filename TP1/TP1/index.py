...
class InvertedIndexReader(InvertedIndex):
    ...
    def __next__(self):
        ...
        try:
            ...
            postings = self.get_postings_list(term)
    ...
    def get_postings_list(self, term):
        ...
        start_pos, _, length = self.postings_dict[term]
        self.index_file.seek(start_pos)
        encoded_postings = self.index_file.read(length)
        return self.encoding_method.decode(encoded_postings)
...
class InvertedIndexWriter(InvertedIndex):
    ...
    def append(self, term, postings_list):
        ...
        encoded_postings = self.encoding_method.encode(postings_list)
